...
### [**Área Metropolitana de la Ciudad de México**]{style="color:#990000"}

```{r casos_importadis}

# Step 1. load the dengue sdm  ####
x <- terra::rast("/Users/felipedzul/Dropbox/posdoctorado_INSP/proyectos/risk_mzmv/11.output/pred_dengue.tif")
...
### [**Área Metropolitana de Ciudad de México**]{style="color:#990000"}
```{r presencia_aedes}


# Step 1. load the sdm aedes ####
pred <- terra::rast("/Users/felipedzul/Dropbox/posdoctorado_INSP/proyectos/risk_mzmv/11.output/pred_ae_aegypti.tif")
...
### [**Área Metropolitana de la Ciudade de México**]{style="color:#990000"}


```{r escenarios}
# Step 1. load the prediction ####
x <- terra::rast("/Users/felipedzul/Dropbox/posdoctorado_INSP/proyectos/risk_mzmv/11.output/pred_class_risk.tif")
...
y <- vroom::vroom("/Users/felipedzul/Dropbox/dataset/inegi/scince/Población total Ciudad de México - 09101 por municipio_demarcación territorial.csv")
